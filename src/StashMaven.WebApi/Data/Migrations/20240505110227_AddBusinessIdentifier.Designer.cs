...
namespace StashMaven.WebApi.Data.Migrations
{
    ...
    [Migration("20240505110227_AddBusinessIdentifier")]
    partial class AddBusinessIdentifier
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StashMaven.WebApi.Data.TaxIdentifier", b =>
                {
                    ...
                    b.ToTable("TaxIdentifier", "partnership");
                });
            ...
            modelBuilder.Entity("StashMaven.WebApi.Data.BusinessIdentifier", b =>
                {
                    b.OwnsOne("StashMaven.WebApi.Data.BusinessIdentifierId", "BusinessIdentifierId", b1 =>
                        {
                            b1.Property<int>("BusinessIdentifierId")
                                .HasColumnType("integer");
                            ...
                            b1.HasKey("BusinessIdentifierId");

                            b1.ToTable("BusinessIdentifier", "partnership");

                            b1.WithOwner()
                                .HasForeignKey("BusinessIdentifierId");
                        });

                    b.Navigation("BusinessIdentifierId")
                        .IsRequired();
                });
